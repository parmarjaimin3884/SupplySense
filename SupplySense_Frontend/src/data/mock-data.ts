...
export const MOCK_RISKS: RiskItem[] = [
  {
    ...
    businessImpact: "₹1,75,000 revenue at risk from deferred customer deliveries.",
    recommendation: "Authorize immediate Purchase Order PO-8921 for 80 units.",
    priority: "P0",
    affectedEntity: "MBP-M3-16",
    timestamp: "10m ago",
    severity: "P0",
    exposureValue: "₹1,75,000",
    impact: "₹1,75,000 revenue at risk from deferred customer deliveries.",
...
export const MOCK_REPORTS = [
  {
    ...
    category: "Inventory",
    format: "PDF & XLSX",
    description: "Detailed breakdown of ₹1.42 Cr active working capital, depot allocation, and low-buffer flags.",
...
export const MOCK_LOGISTICS_ROUTES = [
  ...
  {
    id: "route-2",
    corridor: "International Freight (Tokyo -> Surat Central)",
    carrier: "DHL Express",
    status: "In Transit",
    delayDays: 3,
    reason: "Port customs clearance in progress",
    disruptionRisk: "Medium",
    riskRating: "Medium",
    affectedContainers: 4,
  },
  {
    id: "route-3",
    corridor: "Domestic Logistics (Nhava Sheva -> Surat Central)",
    carrier: "Blue Dart Freight",
    status: "On Schedule",
    delayDays: 0,
    reason: "Express highway corridor operating normally",
    disruptionRisk: "Low",
    riskRating: "Low",
