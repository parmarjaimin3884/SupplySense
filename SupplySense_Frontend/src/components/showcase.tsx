      ...
      <div className="mx-auto max-w-[1280px]">
        ...
        <ScrollReveal animation="fade-up" delay={100}>
          <div className="flex justify-center mb-10">
            <div className="inline-flex flex-wrap items-center justify-center gap-1.5 rounded-2xl border border-[#E5E7EB] bg-white p-2 shadow-xs">
              <button
                type="button"
        ...
        {/* Tab Showcase Card with Smooth Scale-Up */}
