        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {problems.map((prob, idx) => (
            <ScrollReveal
              ...
              className="h-full"
            >
              <div className="h-full rounded-3xl border border-[#E5E7EB] bg-[#F9FAFB] p-8 flex flex-col justify-between hover:bg-white hover:shadow-[0_4px_20px_rgba(0,0,0,0.03)] transition-all">
                <div>
