...
export const assistantApi = {
  async askQuestion(question: string, context?: { page?: string; entityId?: string }): Promise<AIMessage> {
    try {
      ...
      let content = "SupplySense AI model analyzed real-time telematics and ERP streams. Key observation: Stock rebalancing is recommended for high-demand microcontrollers before Wk 33.";
