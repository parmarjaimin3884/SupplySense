"""
SupplySense — Demand Forecast Agent Chains
...
def get_structuring_chain(llm: BaseChatModel):
    ...
    data matching the ForecastAnalysisResponse Pydantic schema.
    Uses LangChain's `with_structured_output` for guaranteed schema compliance.
    """
    structured_llm = llm.with_structured_output(ForecastAnalysisResponse)
